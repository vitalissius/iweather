...
{
    { KEY_PRESSURE, { "atm", "mmHg", "mb", "inHg" } },
    { KEY_SPEED, { "km/h", "m/s", "mph", "ft/s" } },
    { KEY_TEMPERATURE, { "C", "F" } },
    { KEY_PRESSURESTATE, { "Steady", "Rising", "Falling" } },
    { KEY_COMPASSROSE, {
...
{
    { KEY_PRESSURE, { "атм", "мм рт.ст.", "мбар", "дюйм рт.ст." } },
    { KEY_SPEED, { "км/ч", "м/с", "миль/ч", "фт/с" } },
    { KEY_TEMPERATURE, { "C", "F" } },
    { KEY_PRESSURESTATE, { "Постоянное", "Повышается", "Понижается" } },
    { KEY_COMPASSROSE, {
...
{
    { KEY_PRESSURE, { "атм", "мм рт.ст.", "мбар", "дюйм рт.ст." } },
    { KEY_SPEED, { "км/год", "м/с", "миль/год", "фт/с" } },
    { KEY_TEMPERATURE, { "C", "F" } },
    { KEY_PRESSURESTATE, { "Стаціонарний", "Зростаючий", "Спадний" } },
    { KEY_COMPASSROSE, {
